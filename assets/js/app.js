...
function gameOver() {
  ...
  nSpan.innerText = "د ۆ ڕ ا و ی";
  notification.append(nSpan);

  let nBtn = document.createElement("div");
  nBtn.setAttribute("class", "nBtn");
  nBtn.innerText = "دووباره";
...
function buildBettingBoard() {
  ...
  let otoBlocks = ["جووت", "سوور", "ڕەش", "تاک"];
  ...
  let chipValues = [10, 50, 100, 500, "لابردن"];
...
function win(winningSpin, winValue, betTotal) {
  if (winValue > 0) {
    ...
    nsTxt.innerText = " سوڵتانی ڕۆلێت خۆتی";
    nSpan.append(nsTxt);
    ...
    nsWinBlock.innerText = "قوومار: " + betTotal;
    nSpan.append(nsWinBlock);
    nsWin.append(nsWinBlock);
    nsWinBlock = document.createElement("div");
    nsWinBlock.setAttribute("class", "nsWinBlock");
    nsWinBlock.innerText = "بردمۆ: " + winValue;
    nSpan.append(nsWinBlock);
    nsWin.append(nsWinBlock);
    nsWinBlock = document.createElement("div");
    nsWinBlock.setAttribute("class", "nsWinBlock");
    nsWinBlock.innerText = "قازانج: " + (winValue + betTotal);
    nsWin.append(nsWinBlock);
    nSpan.append(nsWin);
    notification.append(nSpan);
    container.prepend(notification);
